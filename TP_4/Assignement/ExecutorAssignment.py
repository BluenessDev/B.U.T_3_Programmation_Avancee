...
def run_java_program(num_throws, num_workers, name_file, mode):
    ...
    class_name = "TP_4.Assignement.Assignment102"  # Vérifie s'il y a un package dans Assignment102.java
...
filenameFaible = computer_name + "_Montecarlo_faible"
filenameForte = computer_name + "_Montecarlo_forte"
